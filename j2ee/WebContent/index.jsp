		...
		<tbody>
			<tr>
				...
				<s:iterator value="slots">
					<td colspan="3" class="slots ends header"><s:property
							value="slotno" /> Time Slot</td>
				</s:iterator>
			</tr>
							...
							<s:if test="scheduleMap.get(#hashkey) != undefined">
								...
								<s:if test="#sizecheck == 1">
									<s:iterator value="scheduleMap.get(#hashkey)">
										<td class="slots" width="130" onclick="deleteEntry(this)">
											<span style="display: none"><s:property value="schid" /></span>
											<s:property value="teachername" />
										</td>
										<td class="slots" width="130"><s:property value="title" /></td>
										<td class="slots ends" width="130"><s:property
												value="sectionname" /> (<s:property value="duration" /> )</td>
									</s:iterator>
								</s:if>
								<s:else>
									<!--else -->
									<td class="slots" width="130">
										<table width="100%" border="0">
											<s:iterator value="scheduleMap.get(#hashkey)">
												<tr height="20px">
													<td align="center" onclick="deleteEntry(this)"><span
														style="display: none"><s:property value="schid" /></span>
									...
									<td class="slots ends" width="130">
										<table width="100%" border="0">
											<s:iterator value="scheduleMap.get(#hashkey)">
												<tr height="20px">
													<td align="center"><s:property value="sectionname" />
